...
class BarChartSample1 extends StatefulWidget {
  ...
  final Color touchedBarColor = const Color.fromARGB(255, 30, 144, 255);
...
class BarChartSample1State extends State<BarChartSample1> {
    ...
    return BarChartData(
      barTouchData: BarTouchData(
        touchTooltipData: BarTouchTooltipData(
          getTooltipColor: (_) => const Color.fromARGB(255, 30, 144, 255),
  ...
  void refreshState() {
    Timer.periodic(animDuration, (Timer timer) {
      if (!isPlaying) {
        timer.cancel();
      }
      setState(() {});
