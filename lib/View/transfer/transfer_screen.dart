    ...
    return Scaffold(
      body: Stack(
        children: [
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Center(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintStyle: TextStyle(
                            color: Colors.grey), // Màu chữ placeholder
                      ),
                      onTap: () {
                ...
                if (selectedZone == null) ...[
                  Row(
                    mainAxisAlignment:
                        MainAxisAlignment.start, // Đặt giữa màn hình
                    children: [
                      Padding(
                  ...
                  const SizedBox(
                      height: 10), // Khoảng cách giữa ô viền và nút tiếp tục
                  SizedBox(
                    width: 365,
                    height: 40,
          ...
          Positioned(
            top: 40, // Cách mép trên cùng
            left: 10, // Cách mép trái
            child: Container(
              width: 40,
              height: 40,
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: Colors.grey[100], // Màu nền hình tròn
              ),
              child: IconButton(
                icon: const Icon(Icons.cancel, color: Colors.blue),
                onPressed: () {
                  // Hành động khi nhấn nút cancel
                  Navigator.pop(context); // Ví dụ: quay lại màn hình trước đó
                },
              ),
            ),
          ),
